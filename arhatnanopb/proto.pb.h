...
typedef enum _arhat_CmdType {
    ...
    arhat_CmdType_CMD_DEV_CONNECT = 1,
    arhat_CmdType_CMD_DEV_OPERATE = 2,
    arhat_CmdType_CMD_DEV_COLLECT_METRICS = 3,
    arhat_CmdType_CMD_DEV_CLOSE = 4
} arhat_CmdType;
...
typedef enum _arhat_MsgType {
    ...
    arhat_MsgType_MSG_DEV_OPERATION_RESULT = 4,
    arhat_MsgType_MSG_DEV_METRICS = 5,
    arhat_MsgType_MSG_DEV_EVENTS = 6
} arhat_MsgType;
...
#define arhat_RegisterMsg_init_default           {0}
...
#define arhat_RegisterMsg_init_zero              {0}
...
#define arhat_RegisterMsg_CALLBACK NULL
...
#define arhat_RegisterMsg_size                   0
